...
### Broken link (0)
### Canonical gap (1)
- raw/references/courses/ 에 langgraph 관련 메모 4 건 있으나 canonical wiki/concepts/langgraph-*.md 페이지는 1 개뿐
...
| **Missing citation** | 인용 추가, 못 찾으면 `> Unverified:` 로 강등 |
...
lint 결과를 보고 필요한 항목만 직접 수정한다.

## 자동화 옵션

매월 1 일 로컬 스케줄러나 GitHub Actions 로 lint 프롬프트를 실행하는 패턴도 가능하다. 자동 수정은 하지 말고 결과만 확인한다.
